...
True Type Font: Advanced Pixel LCD-7 version 1.0


EULA
-==-
The font Advanced Pixel LCD-7 is freeware for home use only.


DESCRIPTION
-=========-
Original pixel font like seven-segment digital clock faces.

Files in advanced_pixel_lcd-7.zip:
       	readme.txt     				this file;
        advanced_pixel_lcd-7.ttf    		regular font;
	advanced_pixel_lcd-7.fon   		font in Windows OS "FON" format;
	advanced_pixel_lcd-7_screen.png		preview image.
